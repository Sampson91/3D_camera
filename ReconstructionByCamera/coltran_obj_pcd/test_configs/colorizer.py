...
def get_config():
    ...
    config.save_checkpoint_secs = 90
    ...
    config.model.encoder.first_frame_size = 32
    config.model.encoder.hidden_size = 32
    config.model.encoder.number_of_heads = 1
    config.model.encoder.number_of_encoder_layers = 1
    config.model.encoder.dropout = 0.0

    # decoder
    config.model.decoder = ConfigDict()
    config.model.decoder.first_frame_size = 32
    config.model.decoder.hidden_size = 32
    config.model.decoder.resolution = [64, 64]
    config.model.decoder.number_of_heads = 1
    config.model.decoder.number_of_inner_layers = 1
    config.model.decoder.number_of_outer_layers = 1
