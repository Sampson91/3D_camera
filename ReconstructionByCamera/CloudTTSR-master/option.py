...
parser.add_argument('--train_crop_size', type=int, default=6252,
...
parser.add_argument('--infer_save_results', type=str2bool, default=False,
                    help='Save each image during inference')
