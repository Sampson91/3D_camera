...
def str2bool(type):
    if type.lower() in ('yes', 'true', 't', 'y', '1'):
        return True
    elif type.lower() in ('no', 'false', 'f', 'n', '0'):
        return False
    else:
...
parser = argparse.ArgumentParser(
    description='TextureTransformerSuperResolution')
...
parser.add_argument('--log_file_name', type=str,
                    default='TextureTransformerSuperResolution.log',
                    help='Log file name')
parser.add_argument('--logger_name', type=str,
                    default='TextureTransformerSuperResolution',
                    help='Logger name')
...
### model setting
parser.add_argument('--number_residual_blocks', type=str, default='16+16+8+4',
                    help='The number of residual blocks in each stage')
parser.add_argument('--number_features', type=int, default=64,
                    help='The number of channels in network')
parser.add_argument('--residual_scale', type=float, default=1.,
...
parser.add_argument('--lr_rate_lte', type=float, default=1e-5,
                    help='Learning rate of LearnableTextureExtractor')
...
###############################################################################
# parser.add_argument('--sampling_magnification', type=int, default=1,
#                     help='magnification for upsample or downsample')
parser.add_argument('--image_height', type=int, default=1080,
                    help='image height')
parser.add_argument('--image_width', type=int, default=1920,
                    help='image width')
parser.add_argument('--custom_size', type=str2bool, default=False,
                    help='Test mode')
parser.add_argument('--preview_directory', type=str, default='./dataset/preview_image/',
                    help='Directory of preview')
